...
<div class="row">
    ...
    <button type="button" class="waves-effect waves-light btn " id="chapter_wise">Chapter Wise</button>
    <button type="button" class="waves-effect waves-light btn " id="qtype_wise">Qtype Wise</button>
    <button type="button" class="waves-effect waves-light btn " id="qlevel_wise">Qlevel Wise</button>
