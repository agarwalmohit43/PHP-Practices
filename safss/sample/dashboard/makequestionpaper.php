    ...
    <form id="makequestionpaper">
        <div class="container" style="margin-left: 400px;margin-top: 50px;">
            ...
            <div class="row">
                ...
                <div class="input-field col 4">
                    <select id="qtype" name="qtype" multiple>
        ...
        <div class="row">
            ...
            <input type="number"  placeholder="Enter the marks" min="0" max="20" style="visibility: visible;width: 200px" id="">
        </div>
        <div class="row">
            <div class="input-field col 6" style="margin-left: 400px">
                <input type="number" placeholder="hr" min="0" max="3" style="visibility: visible;width: 40px" id="">
                <input type="number" placeholder="min" min="0" max="60" style="visibility: visible;width: 40px" id="">
            </div>
            <div class="input-field col 6" style="margin-left: 200px">
                <input type="email" placeholder="enter email Id" style="visibility: visible;width: 250px" id="">
            </div>
        </div>

        <div class="row" >
            <a href="javascript:$('#makequestionpaper').submit();" class="waves-effect waves-light btn" type="Submit">Submit</a>
        </div>
    </form>
</center>
...
<script type="text/javascript">
    ...
    /*$('#qtype').change(function (e) {
     ...
     if($.inArray("Long",a)==0){
     $('#qslong').removeAttr("style");
     }else if($.inArray("Short",a)==0){
     $('#qsshort').removeAttr("style");
     }else if($.inArray("Small",a)==0){
     $('#qssmall').removeAttr("style");
     }else {
     /!*if($.inArray("Long",a)==0){
     $('#qslong').removeAttr("style");
     }else {
     $('#qslong').css("visibility","hidden");
     }

     if($.inArray("Short",a)==0) {
     $('#qsshort').removeAttr("style");
     }else {
     $('#qsshort').css("visibility","hidden");
     }

     if($.inArray("Small",a)==0) {
     $('#qssmall').removeAttr("style");
     }else {
     $('#qssmall').css("visibility","hidden");
     }*!/
     $('#qslong').css("visibility","hidden");
     $('#qsshort').css("visibility","hidden");
     $('#qssmall').css("visibility","hidden");
