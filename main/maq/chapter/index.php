...
<html>
 <head>
  ...
  <script>
	 ...
	 var columns = new Array("chapter","sid");
	 var placeholder = new Array("Enter Chapter","Please enter sid as above");
...
<link href="bootstrap.min.css" />
 ...
 <body>
    ...
    <br/>  
	     <a href="http://localhost/project/maq/index.php?sname=<?php echo $_GET['sname']?>">Back</a>

     <a href="http://localhost/project/maq/cat/index.php?sname=<?php echo $_GET['sname']?>">MAQ</a>
<script>
